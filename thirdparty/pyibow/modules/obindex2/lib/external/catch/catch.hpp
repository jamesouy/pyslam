...
#define ALT_STACK_MEM_SIZE 32768  // quick&dirty patch https://github.com/r-lib/testthat/issues/1373 for build error related to SIGSTKSZ
#else
#define ALT_STACK_MEM_SIZE SIGSTKSZ
#endif
...
struct FatalConditionHandler {
    ...
    static char altStackMem[ALT_STACK_MEM_SIZE];
    ...
    FatalConditionHandler() {
        ...
        sigStack.ss_size = ALT_STACK_MEM_SIZE;
        sigStack.ss_flags = 0;
...
char FatalConditionHandler::altStackMem[ALT_STACK_MEM_SIZE] = {};
